...
useEffect(() => {
  ...
  async function init() {
    ...
    if (typeof document !== "undefined" && "fonts" in document) {
      try {
        // Make sure the exact weight/family is loaded
        await (document as any).fonts.load('500 200px "IBM Plex Mono"');
    ...
    if (width === 0 || height === 0) return; // you can keep your IntersectionObserver block here if you want
